package com.yashbuysell.psbuyandsell.viewmodel.chat;
...
import com.yashbuysell.psbuyandsell.repository.chat.ChatRepository;
...
public class ChatViewModel extends PSViewModel {
    ...
    ChatViewModel(ChatRepository repository) {
        ...
        fetchMessagesFromConversationData = Transformations.switchMap(fetchMessagesFromConversationObj, obj -> {
            ...
            return repository.getMessagesFromSpecificNode(obj.senderId, obj.receiverId , obj.context );
...
//    }
    ...
    public void setFetchMessagesFromConversationObj(String senderId, String receiverId , Context context) {
        if (!isLoading) {
            fetchMessagesTmpDataHolder tmpDataHolder = new fetchMessagesTmpDataHolder(senderId, receiverId, "" , context);
    ...
    public void setGetMessagesFromDatabaseObj(String senderId, String receiverId, String itemId , Context context) {
        fetchMessagesTmpDataHolder tmpDataHolder = new fetchMessagesTmpDataHolder(senderId, receiverId, itemId, context);
    ...
    public void setCheckReceiverStatusObj(String senderId, String receiverId, String itemId, Context context) {
        fetchMessagesTmpDataHolder tmpDataHolder = new fetchMessagesTmpDataHolder(senderId, receiverId, itemId, context);
...
//    }
    ...
    class fetchMessagesTmpDataHolder {
        ...
        fetchMessagesTmpDataHolder(String senderId, String receiverId, String itemId , Context context) {
            this.senderId = senderId;
