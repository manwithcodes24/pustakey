package com.yashbuysell.psbuyandsell.ui.offlinepayment;
...
import com.yashbuysell.psbuyandsell.databinding.FragmentOfflineBinding;
...
import com.yashbuysell.psbuyandsell.ui.offlinepayment.adapter.OfflinePaymentAdapter;
...
public  class OfflinePaymentHeaderListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface{
    ...
    protected void initUIAndActions() {
      ...
      binding.get().payofflineButton.setOnClickListener(v -> itemPaidHistoryViewModel.setUploadItemPaidHistoryData(
