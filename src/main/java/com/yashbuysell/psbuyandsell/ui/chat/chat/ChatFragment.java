package com.yashbuysell.psbuyandsell.ui.chat.chat;
...
import com.yashbuysell.psbuyandsell.databinding.FragmentChatBinding;
import com.yashbuysell.psbuyandsell.databinding.ItemRatingEntryBinding;
import com.yashbuysell.psbuyandsell.ui.chat.adapter.ChatListAdapter;
...
import com.yashbuysell.psbuyandsell.viewobject.ChatHistory;
...
import com.yashbuysell.psbuyandsell.viewobject.messageHolder.Chat;
import com.yashbuysell.psbuyandsell.viewobject.messageHolder.Message;
import com.yashbuysell.psbuyandsell.viewobject.messageHolder.UserStatusHolder;
...
import static com.facebook.FacebookSdk.getSdkVersion;
...
public class ChatFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private String userMessage = Constants.EMPTY_STRING;
    @VisibleForTesting
    ...
    protected void initUIAndActions() {
        ...
        binding.get().labelButton.setOnClickListener(view -> {
        ...
        binding.get().sendButton.setOnClickListener(v -> {
           userMessage = binding.get().editText.getText().toString().trim() ;
                ...
                if (layoutManager1 != null) {
                    ...
                    if (firstPosition == adapter.get().getItemCount() - 1) {
                        ...
                        if (!binding.get().getLoadingMore() && !chatViewModel.forceEndLoading) {
                            ...
                            chatViewModel.setFetchMessagesFromConversationObj(loginUserId, chatViewModel.receiverId, getApplicationContext());
                        }
            ...
            if (listResource != null) {
                switch (listResource.status) {
                    case SUCCESS:
                        ...
                        chatViewModel.setGetMessagesFromDatabaseObj(loginUserId, chatViewModel.receiverId, chatViewModel.itemId, getApplicationContext());
...
//        chatViewModel.setSaveChatToFirebaseObj(new Chat(loginUserId, chatViewModel.receiverId, chatViewModel.itemId), loginUserId, chatViewModel.receiverId);
        ...
        chatViewModel.setCheckReceiverStatusObj(loginUserId, chatViewModel.receiverId, chatViewModel.itemId, getApplicationContext());
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference(chatViewModel.itemId);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    ...
                    Log.d("orderStatus" , "error = " + e.getMessage().toString());
            ...
            if (result != null) {
                switch (result.status) {
                    case SUCCESS:
                        ...
                        Log.d("notisentSuccess" ,  "Notification sent") ;
                        break;
    ...
    private void pushNoti() {
        if (!active) {
            ...
            if (chatViewModel.chatFlag.equals(Constants.CHAT_FROM_BUYER)) {
                ...
                notificationViewModel.setSendChatNotiObj(chatViewModel.itemId, chatViewModel.receiverId, loginUserId, userMessage, Constants.CHAT_TO_BUYER);
                ...
                fcmRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        try {
                            String fcmtoken = snapshot.child(chatViewModel.receiverId).child("fcmtoken").getValue().toString() ;
                            ...
                            notiObj.put("title", "Buyer sent you a message") ;
                ...
                notificationViewModel.setSendChatNotiObj(chatViewModel.itemId, loginUserId, chatViewModel.receiverId, userMessage, Constants.CHAT_TO_SELLER);
                DatabaseReference fcmRef = FirebaseDatabase.getInstance().getReference("users") ;
                fcmRef.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
