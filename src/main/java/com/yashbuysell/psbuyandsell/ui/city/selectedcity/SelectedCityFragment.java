package com.yashbuysell.psbuyandsell.ui.city.selectedcity;
...
import com.yashbuysell.psbuyandsell.databinding.FragmentSelectedCityBinding;
import com.yashbuysell.psbuyandsell.ui.category.adapter.CityCategoryAdapter;
...
import com.yashbuysell.psbuyandsell.ui.dashboard.adapter.DashBoardViewPagerAdapter;
import com.yashbuysell.psbuyandsell.ui.item.adapter.ItemHorizontalListAdapter;
...
public class SelectedCityFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private ItemViewModel recentItemViewModel;
...
//        });
    ...
    protected void initViewModels() {
        ...
        recentItemViewModel = new ViewModelProvider(this, viewModelFactory).get(ItemViewModel.class);
...
//            }
            ...
            recentItemViewModel.mapLat = selectedLat;
            recentItemViewModel.mapLng = selectedLng;

            recentItemViewModel.holder.location_id = recentItemViewModel.locationId;
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null) {
            if (requestCode == Constants.REQUEST_CODE__SELECTED_CITY_FRAGMENT
                ...
                recentItemViewModel.mapLat = data.getStringExtra(Constants.LAT);
                recentItemViewModel.mapLng = data.getStringExtra(Constants.LNG);
                ...
                pref.edit().putString(Constants.LAT, recentItemViewModel.mapLat).apply();
                pref.edit().putString(Constants.LNG, recentItemViewModel.mapLng).apply();
