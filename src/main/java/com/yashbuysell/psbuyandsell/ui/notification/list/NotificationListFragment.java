package com.yashbuysell.psbuyandsell.ui.notification.list;
...
import com.yashbuysell.psbuyandsell.databinding.FragmentNotificationListBinding;
...
import com.yashbuysell.psbuyandsell.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.yashbuysell.psbuyandsell.viewobject.Noti> notificationList) {
