...
import com.yashbuysell.psbuyandsell.ui.apploading.AppLoadingActivity;
import com.yashbuysell.psbuyandsell.ui.apploading.AppLoadingFragment;
import com.yashbuysell.psbuyandsell.ui.blog.detail.BlogDetailActivity;
import com.yashbuysell.psbuyandsell.ui.blog.detail.BlogDetailFragment;
import com.yashbuysell.psbuyandsell.ui.blog.list.BlogListActivity;
import com.yashbuysell.psbuyandsell.ui.blog.list.BlogListFragment;
import com.yashbuysell.psbuyandsell.ui.category.categoryfilter.CategoryFilterFragment;
import com.yashbuysell.psbuyandsell.ui.category.list.CategoryListActivity;
import com.yashbuysell.psbuyandsell.ui.category.list.CategoryListFragment;
...
import com.yashbuysell.psbuyandsell.ui.chat.chatimage.ChatImageFullScreenActivity;
import com.yashbuysell.psbuyandsell.ui.chat.chatimage.ChatImageFullScreenFragment;
import com.yashbuysell.psbuyandsell.ui.chathistory.BuyerFragment;
import com.yashbuysell.psbuyandsell.ui.chathistory.MessageFragment;
import com.yashbuysell.psbuyandsell.ui.chathistory.SellerFragment;
import com.yashbuysell.psbuyandsell.ui.city.menu.CityMenuFragment;
import com.yashbuysell.psbuyandsell.ui.city.selectedcity.SelectedCityActivity;
import com.yashbuysell.psbuyandsell.ui.city.selectedcity.SelectedCityFragment;
import com.yashbuysell.psbuyandsell.ui.contactus.ContactUsFragment;
import com.yashbuysell.psbuyandsell.ui.customcamera.CameraActivity;
import com.yashbuysell.psbuyandsell.ui.customcamera.CameraFragment;
import com.yashbuysell.psbuyandsell.ui.customcamera.setting.CameraSettingActivity;
import com.yashbuysell.psbuyandsell.ui.customcamera.setting.CameraSettingFragment;
import com.yashbuysell.psbuyandsell.ui.dashboard.DashBoardSearchCategoryFragment;
import com.yashbuysell.psbuyandsell.ui.dashboard.DashBoardSearchFragment;
import com.yashbuysell.psbuyandsell.ui.dashboard.DashBoardSearchSubCategoryFragment;
import com.yashbuysell.psbuyandsell.ui.dashboard.DashboardSearchByCategoryActivity;
import com.yashbuysell.psbuyandsell.ui.forceupdate.ForceUpdateActivity;
import com.yashbuysell.psbuyandsell.ui.forceupdate.ForceUpdateFragment;
import com.yashbuysell.psbuyandsell.ui.gallery.GalleryActivity;
import com.yashbuysell.psbuyandsell.ui.gallery.GalleryFragment;
import com.yashbuysell.psbuyandsell.ui.gallery.detail.GalleryDetailActivity;
import com.yashbuysell.psbuyandsell.ui.gallery.detail.GalleryDetailFragment;
import com.yashbuysell.psbuyandsell.ui.item.detail.ItemActivity;
import com.yashbuysell.psbuyandsell.ui.item.detail.ItemFragment;
...
import com.yashbuysell.psbuyandsell.ui.item.history.UserHistoryListActivity;
import com.yashbuysell.psbuyandsell.ui.item.itemcondition.ItemConditionFragment;
import com.yashbuysell.psbuyandsell.ui.item.itemcurrency.ItemCurrencyTypeFragment;
import com.yashbuysell.psbuyandsell.ui.item.itemdealoption.ItemDealOptionTypeFragment;
import com.yashbuysell.psbuyandsell.ui.item.itemfromfollower.ItemFromFollowerListActivity;
import com.yashbuysell.psbuyandsell.ui.item.itemfromfollower.ItemFromFollowerListFragment;
import com.yashbuysell.psbuyandsell.ui.item.itemlocation.ItemLocationFragment;
import com.yashbuysell.psbuyandsell.ui.item.itemlocationfilter.ItemLocationFilterActivity;
import com.yashbuysell.psbuyandsell.ui.item.itemlocationfilter.ItemLocationFilterFragment;
import com.yashbuysell.psbuyandsell.ui.item.itempricetype.ItemPriceTypeFragment;
import com.yashbuysell.psbuyandsell.ui.item.itemtype.ItemTypeFragment;
import com.yashbuysell.psbuyandsell.ui.item.itemtype.SearchViewActivity;
import com.yashbuysell.psbuyandsell.ui.item.loginUserItem.LoginUserItemFragment;
import com.yashbuysell.psbuyandsell.ui.item.loginUserItem.LoginUserItemListActivity;
import com.yashbuysell.psbuyandsell.ui.item.loginUserItem.LoginUserPaidItemFragment;
import com.yashbuysell.psbuyandsell.ui.item.map.MapActivity;
import com.yashbuysell.psbuyandsell.ui.item.map.MapFragment;
import com.yashbuysell.psbuyandsell.ui.item.map.PickMapFragment;
import com.yashbuysell.psbuyandsell.ui.item.map.mapFilter.MapFilteringActivity;
import com.yashbuysell.psbuyandsell.ui.item.map.mapFilter.MapFilteringFragment;
import com.yashbuysell.psbuyandsell.ui.item.promote.ItemPromoteActivity;
import com.yashbuysell.psbuyandsell.ui.item.promote.ItemPromoteFragment;
import com.yashbuysell.psbuyandsell.ui.item.rating.RatingListActivity;
import com.yashbuysell.psbuyandsell.ui.item.rating.RatingListFragment;
import com.yashbuysell.psbuyandsell.ui.item.readmore.ReadMoreActivity;
import com.yashbuysell.psbuyandsell.ui.item.readmore.ReadMoreFragment;
import com.yashbuysell.psbuyandsell.ui.item.search.searchlist.SearchListActivity;
import com.yashbuysell.psbuyandsell.ui.item.search.searchlist.SearchListFragment;
import com.yashbuysell.psbuyandsell.ui.item.search.specialfilterbyattributes.FilteringActivity;
import com.yashbuysell.psbuyandsell.ui.item.search.specialfilterbyattributes.FilteringFragment;
import com.yashbuysell.psbuyandsell.ui.language.LanguageFragment;
import com.yashbuysell.psbuyandsell.ui.location.LocationActivity;
import com.yashbuysell.psbuyandsell.ui.notification.detail.NotificationActivity;
import com.yashbuysell.psbuyandsell.ui.notification.detail.NotificationFragment;
import com.yashbuysell.psbuyandsell.ui.notification.list.NotificationListActivity;
import com.yashbuysell.psbuyandsell.ui.notification.list.NotificationListFragment;
import com.yashbuysell.psbuyandsell.ui.notification.setting.NotificationSettingActivity;
import com.yashbuysell.psbuyandsell.ui.notification.setting.NotificationSettingFragment;
import com.yashbuysell.psbuyandsell.ui.offer.OfferBuyerFragment;
import com.yashbuysell.psbuyandsell.ui.offer.OfferSellerFragment;
import com.yashbuysell.psbuyandsell.ui.offer.OfferContainerFragment;
import com.yashbuysell.psbuyandsell.ui.offlinepayment.OfflinePaymentActivity;
import com.yashbuysell.psbuyandsell.ui.offlinepayment.OfflinePaymentHeaderListFragment;
import com.yashbuysell.psbuyandsell.ui.privacypolicy.PrivacyPolicyActivity;
import com.yashbuysell.psbuyandsell.ui.privacypolicy.PrivacyPolicyFragment;
import com.yashbuysell.psbuyandsell.ui.safetytip.SafetyTipFragment;
import com.yashbuysell.psbuyandsell.ui.safetytip.SafetyTipsActivity;
import com.yashbuysell.psbuyandsell.ui.setting.SettingActivity;
import com.yashbuysell.psbuyandsell.ui.setting.SettingFragment;
import com.yashbuysell.psbuyandsell.ui.setting.appinfo.AppInfoActivity;
import com.yashbuysell.psbuyandsell.ui.setting.appinfo.AppInfoFragment;
import com.yashbuysell.psbuyandsell.ui.stripe.StripeActivity;
import com.yashbuysell.psbuyandsell.ui.stripe.StripeFragment;
import com.yashbuysell.psbuyandsell.ui.subcategory.SubCategoryActivity;
import com.yashbuysell.psbuyandsell.ui.subcategory.SubCategoryFragment;
import com.yashbuysell.psbuyandsell.ui.user.PasswordChangeActivity;
import com.yashbuysell.psbuyandsell.ui.user.PasswordChangeFragment;
import com.yashbuysell.psbuyandsell.ui.user.ProfileEditActivity;
import com.yashbuysell.psbuyandsell.ui.user.ProfileEditFragment;
import com.yashbuysell.psbuyandsell.ui.user.ProfileFragment;
import com.yashbuysell.psbuyandsell.ui.user.UserFBRegisterActivity;
import com.yashbuysell.psbuyandsell.ui.user.UserFBRegisterFragment;
import com.yashbuysell.psbuyandsell.ui.user.UserForgotPasswordActivity;
import com.yashbuysell.psbuyandsell.ui.user.UserForgotPasswordFragment;
import com.yashbuysell.psbuyandsell.ui.user.UserLoginActivity;
import com.yashbuysell.psbuyandsell.ui.user.UserLoginFragment;
import com.yashbuysell.psbuyandsell.ui.user.UserRegisterActivity;
import com.yashbuysell.psbuyandsell.ui.user.UserRegisterFragment;
import com.yashbuysell.psbuyandsell.ui.user.phonelogin.PhoneLoginActivity;
import com.yashbuysell.psbuyandsell.ui.user.phonelogin.PhoneLoginFragment;
import com.yashbuysell.psbuyandsell.ui.user.userlist.UserListActivity;
import com.yashbuysell.psbuyandsell.ui.user.userlist.UserListFragment;
import com.yashbuysell.psbuyandsell.ui.user.userlist.detail.UserDetailActivity;
import com.yashbuysell.psbuyandsell.ui.user.userlist.detail.UserDetailFragment;
import com.yashbuysell.psbuyandsell.ui.user.verifyemail.VerifyEmailActivity;
import com.yashbuysell.psbuyandsell.ui.user.verifyemail.VerifyEmailFragment;
import com.yashbuysell.psbuyandsell.ui.user.verifyphone.VerifyMobileActivity;
import com.yashbuysell.psbuyandsell.ui.user.verifyphone.VerifyMobileFragment;
